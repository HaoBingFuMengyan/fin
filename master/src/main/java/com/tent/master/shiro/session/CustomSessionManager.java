package com.tent.master.shiro.session;

import com.tent.master.customer.bo.UserOnlineBo;
import com.tent.master.shiro.CustomShiroSessionDAO;
...
public class CustomSessionManager {
	...
	private UserOnlineBo getSessionBo(Session session){
		...
		if(obj instanceof SimplePrincipalCollection){
			 ...
			 * return new SimpleAuthenticationInfo(hy,hy.getPswd(), getName());的user 对象。
			 */
			obj = spc.getPrimaryPrincipal();
			if(null != obj && obj instanceof User){
				//存储session + hy 综合信息
